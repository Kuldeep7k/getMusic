...
<body>
        ...
        <div class="container-fluid my-3">
            ...
            <section class="text-center mt-4 mb-2 mx-4">
                <div class="row">
                    ...
                    $result = $con->query("SELECT * FROM `songs_data` WHERE id between $range_b and $range_a ORDER by id desc");
    ...
    <nav aria-label="...">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
                <a class="page-link"
                    href="page.php?lma=<?php echo $range_a; ?>&lmb=<?php echo $range_b; ?>&page=2">Next</a>
            </li>
        </ul>
    </nav>
